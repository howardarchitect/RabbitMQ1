...
public class FanoutExchangeConfig {
	...
	FanoutExchange directExchange() {
		return new FanoutExchange(de, true, false);
	}

	Binding db1() {
		return BindingBuilder.bind(createQueue1()).to(directExchange());
	}

	Binding db2() {
		return BindingBuilder.bind(createQueue2()).to(directExchange());
	}
